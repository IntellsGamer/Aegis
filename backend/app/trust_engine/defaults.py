...
DEFAULT_RULES: list[dict] = [
    ...
    {"code": "tls_certificate_probe_limited", "name": "TLS certificate check unavailable", "category": "availability",
     "impact": 0, "weight": 1.0, "severity": "info", "enabled": True,
     "explain": "The TLS certificate probe could not finish. This limits coverage and is not evidence of a threat."},
