(function () {
  ...
  const translations = {
    fa: {
      ...
      'report.title_https': 'HTTPS فعال است', 'report.title_ssl_valid': 'گواهی SSL معتبر است', 'report.title_domain_very_old': 'دامنه سابقهٔ طولانی دارد', 'report.title_domain_old': 'دامنه سابقه‌دار است', 'report.title_no_scam_patterns': 'الگوی کلاه‌برداری شناخته‌شده‌ای دیده نشد',
      'report.desc_https': 'وب‌سایت با اتصال رمزنگاری‌شدهٔ HTTPS ارائه می‌شود.', 'report.desc_ssl_valid': 'گواهی SSL این نشانی در حال حاضر معتبر است.', 'report.desc_domain_very_old': 'این دامنه بیش از پنج سال پیش ثبت شده است؛ این یک نشانهٔ مثبت اعتماد است.', 'report.desc_domain_old': 'این دامنه بیش از یک سال سابقهٔ ثبت دارد.', 'report.desc_no_scam_patterns': 'در شواهد گردآوری‌شده الگوی شناخته‌شده‌ای از کلاه‌برداری پیدا نشد.',
