(function () {
  ...
  const translations = {
    fa: {
      ...
      'scan.title': 'بررسی کلاهبرداری',
      'scan.description': 'پیوند، ایمیل، پیام، تصویر، کد QR یا فایل را بررسی کنید. AEGIS نشانه‌های قابل مشاهده را کنار هم می‌گذارد، نشانه‌های تکراری را کم‌اثر می‌کند و روشن می‌گوید چرا به این نتیجه رسیده است.',
      'scan.prediction_path': 'روش بررسی',
      'scan.no_training': 'بدون مدلِ آموزش‌دیده',
      'scan.load_demo': 'نمایش نمونه',
      'scan.collect': '۱. دریافت نشانه‌ها',
      'scan.collect_desc': 'پیوندها، فرستنده، سرنخ‌های متن و داده‌های فنی بررسی می‌شوند.',
      'scan.correlate': '۲. سنجش هم‌خوانی',
      'scan.correlate_desc': 'تکرارِ یک نشانه نتیجه را بزرگ‌نمایی نمی‌کند؛ هم‌خوانیِ نشانه‌های مستقل مهم‌تر است.',
      'scan.explain': '۳. توضیح نتیجه',
      ...
      'scan.demo_loaded': 'نمونهٔ ساختگیِ فیشینگ آماده شد. نشانه‌ها را ببینید و سپس «تحلیل» را بزنید.',
      ...
      'dashboard.greeting': 'سلام {username}، اینجا نمایی از وضعیت امنیتی حسابتان است.', 'dashboard.scans': 'بررسی‌ها', 'dashboard.threats': 'موارد پرخطر', 'dashboard.average_score': 'میانگین امتیاز اعتماد', 'dashboard.needs_attention': 'نیازمند رسیدگی', 'dashboard.scan_type_url': 'پیوند', 'dashboard.scan_type_email': 'ایمیل', 'dashboard.scan_type_text': 'پیام', 'dashboard.scan_type_image': 'تصویر', 'dashboard.scan_type_qr': 'کد QR', 'dashboard.scan_type_file': 'فایل',
